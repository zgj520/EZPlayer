...
HRESULT AudioPlayer::Init() {
    ...
    hr = pAudioSessionManager->GetAudioSessionControl(&GUID_NULL, FALSE, &pAudioSession);
    hr = pAudioSessionManager->GetSimpleAudioVolume(&GUID_NULL, 0, &pSimpleAudioVolume);
